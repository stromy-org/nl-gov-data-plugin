...
Look for a charter file at `companies/nl-ez/charter.json` where `<name>` matches the company the user mentions. If a charter exists, it provides:
...
charter = json.loads(Path('companies/nl-ez/charter.json').read_text())
